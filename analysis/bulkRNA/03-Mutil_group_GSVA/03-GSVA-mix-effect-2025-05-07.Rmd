...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
  fig.path = "./results/04-Mix-effect-comb_drug/Analysis_figure/"
)
...
result_df <- data.frame(
  ...
  combined_p_FXS_Drug_BAY = numeric(),
  combined_p_FXS_Drug_BPN = numeric(),
  combined_p_FXS_Drug_BP = numeric(),
...
# for (i in 1:5) {
  ...
  p_comb_fxs_bay <- tryCatch({
    linearHypothesis(model, "X_Drug_BAY + X_FXS:X_Drug_BAY = 0")$`Pr(>Chisq)`[2]
  }, error = function(e) NA)
  
  p_comb_fxs_bpn <- tryCatch({
    linearHypothesis(model, "X_Drug_BPN + X_FXS:X_Drug_BPN = 0")$`Pr(>Chisq)`[2]
  }, error = function(e) NA)
  
  p_comb_fxs_bp <- tryCatch({
    linearHypothesis(model, "X_Drug_BP + X_FXS:X_Drug_BP = 0")$`Pr(>Chisq)`[2]
  }, error = function(e) NA)
  ...
  result_df <- rbind(result_df, data.frame(
    ...
    combined_p_FXS_Drug_BAY = p_comb_fxs_bay,
    combined_p_FXS_Drug_BPN = p_comb_fxs_bpn,
    combined_p_FXS_Drug_BP = p_comb_fxs_bp,
    stringsAsFactors = FALSE
  ))
}
...
# View(result_df)
write.csv(result_df, "./results/04-Mix-effect-comb_drug/mixed_model_results_all.csv", row.names = FALSE)
...
result_df <- read.csv("./results/04-Mix-effect-comb_drug/mixed_model_results_all.csv")
...
write.csv(result_df_BAY, "./results/04-Mix-effect-comb_drug/mixed_model_results_BAY.csv", row.names = FALSE)
...
#                       figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_BAY_all_DRUG"),
...
#                       pathway_name =  pathway_name,
#                       figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_BAY"),
...
result_df_BPN <- result_df_BPN %>% filter(side_effect == "No Side Effect") %>% 
  dplyr::select(pathway,rescue, side_effect, everything())
write.csv(result_df_BPN, "./results/04-Mix-effect-comb_drug/mixed_model_results_BPN.csv", row.names = FALSE)
...
#                       condition_list_label = condition_list_label,
#                       pathway_name =  pathway_name,
#                       figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_BPN_all_DRUG"),
#                       file_name = paste0("GSVA_", pathway_name, "_DRUG"),
#                       fig.height = 6, fig.width = 6)
# 
# 
...
#                       pathway_name =  pathway_name,
#                       figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_BPN"),
...
result_df_BP <- result_df_BP %>% filter(side_effect == "No Side Effect") %>% 
  dplyr::select(pathway,rescue, side_effect, everything())
write.csv(result_df_BP, "./results/04-Mix-effect-comb_drug/mixed_model_results_BP.csv", row.names = FALSE)
...
#                              condition_list_label = condition_list_label,
#                              pathway_name =  pathway_name,
#                              figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_BP_all_DRUG"),
#                              file_name = paste0("GSVA_", pathway_name, "_DRUG"),
#                              fig.height = 6, fig.width = 6)
#   
#   
...
#                              pathway_name =  pathway_name,
#                              figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_BP"),
...
for (i in 1:length(pathway_overlap_3)) {
  ...
  p<-plot_gsva_boxplot_mutil(gsva_matrix,
                          condition_list_label = condition_list_label,
                          pathway_name =  pathway_name,
                          figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_Overlap_3"),
                          file_name = paste0("GSVA_", pathway_name, "_DRUG"),
                          fig.height = 6, fig.width = 6)
  print(p)
...
write.csv(pathway_overlap_3, "./results/04-Mix-effect-comb_drug/pathway_overlap_3.csv", row.names = FALSE)
...
#                           condition_list_label = condition_list_label,
#                           pathway_name =  pathway_name,
#                           figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_Overlap_BAY_BPN_all"),
#                           file_name = paste0("GSVA_", pathway_name, "_DRUG"),
#                           fig.height = 6, fig.width = 6)
# 
#     plot_gsva_boxplot_mutil(gsva_matrix,
...
#                           pathway_name =  pathway_name,
#                           figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_Overlap_BAY_BPN"),
#                           file_name = paste0("GSVA_", pathway_name, "_DRUG"),
#                           fig.height = 6, fig.width = 6)
# 
# 
...
write.csv(pathway_overlap_BAY_BPN, "./results/04-Mix-effect-comb_drug/pathway_overlap_BAY_BPN.csv", row.names = FALSE)
...
#                           condition_list_label = condition_list_label,
#                           pathway_name =  pathway_name,
#                           figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_Overlap_BAY_BP_all"),
#                           file_name = paste0("GSVA_", pathway_name, "_DRUG"),
#                           fig.height = 6, fig.width = 6)
# 
#     plot_gsva_boxplot_mutil(gsva_matrix,
...
#                           pathway_name =  pathway_name,
#                           figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_Overlap_BAY_BP"),
#                           file_name = paste0("GSVA_", pathway_name, "_DRUG"),
#                           fig.height = 6, fig.width = 6)
# 
# 
...
write.csv(pathway_overlap_BAY_BP, "./results/04-Mix-effect-comb_drug/pathway_overlap_BAY_BP.csv", row.names = FALSE)
...
#                           condition_list_label = condition_list_label,
#                           pathway_name =  pathway_name,
#                           figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_Overlap_BPN_BP_all"),
#                           file_name = paste0("GSVA_", pathway_name, "_DRUG"),
#                           fig.height = 6, fig.width = 6)
# 
#     plot_gsva_boxplot_mutil(gsva_matrix,
...
#                           pathway_name =  pathway_name,
#                           figure_folder = file.path(result_folder,"04-Mix-effect-comb_drug","Boxplot_Overlap_BPN_BP"),
#                           file_name = paste0("GSVA_", pathway_name, "_DRUG"),
#                           fig.height = 6, fig.width = 6)
# 
# 
...
write.csv(pathway_overlap_BPN_BP, "./results/04-Mix-effect-comb_drug/pathway_overlap_BPN_BP.csv", row.names = FALSE)
