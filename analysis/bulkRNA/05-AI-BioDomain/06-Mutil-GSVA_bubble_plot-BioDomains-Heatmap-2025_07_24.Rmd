...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
  fig.path = "./results/06-Mannual-result/Analysis_figure/"
)
...
AI_biodomain <- read.csv(here::here("data", "ref", "FXS_bidomain_annotation_full.csv")) %>%
  dplyr::select(pathway,JX_annotation) %>%
  dplyr::distinct() %>%
  rename(Biodomain = JX_annotation) 
...
for(cfg in plot_configs) {
  ...
  print(fname)
  ggsave(paste0("./results/06-Mannual-result/Bubble_", fname, ".png"),
         plot = p, width = 8, height = 7)
  ggsave(paste0("./results/06-Mannual-result/Bubble_", fname, ".pdf"),
         plot = p, width = 8, height = 7)
}
