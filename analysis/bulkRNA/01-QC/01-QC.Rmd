...
sample_df <- read.csv(here::here("data", "bulkRNA", 
                                 "sample_info_FXS.csv"), header = TRUE)


sample_list <- sample_df$Sample_name
condition_list <-  sample_df$Diagosis
counts_ref <- read.csv(here::here("data", "bulkRNA",
                                  "raw","19149-152-01_S1_L001_final_gene_with_names.csv"), 
                       header = TRUE)
...
colnames(counts) <- c("GeneID","GeneName" ,sample_df$Sample_ID)
